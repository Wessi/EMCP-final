...
<br><br>
	<div class="panel panel-primary">
                ...
                <thead class="thead-dark">
                  <tr>
                    <th><i class="icon_table"></i>FirstName:</th>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<td width="50%" style="padding-left:10px">
          ...
          <div class="form-group row">
            <label for="recipient-name" class="col-sm-4 col-form-label">enabled:</label>
            <div class ="col-sm-6">
            <input type="number" class="form-control" id="recipient-name" name="enabled">
            </div>
          </div>
		    ...
		    <div class ="col-sm-6">
			    <select class="form-control" id="orgid" name="theorgid"  required>
