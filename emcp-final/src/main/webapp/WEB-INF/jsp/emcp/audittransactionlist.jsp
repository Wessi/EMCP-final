                  ...
                  <c:forEach items="${mastertransactionlists}" var="transaction">
						<tr>
							...
							<td><a type="button" class="btn btn-success" id="editButton"
								href="/mastertransactionlists/findById?id=${transaction.id}">Assign status</a>
							<a type="button" class="btn btn-warning" id="detailButton"
								href="/mastertransactionlists/findById?id=${transaction.id}">Details</a></td>
